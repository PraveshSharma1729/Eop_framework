...
job_parent_folder=current_dir+"/jobs_2016_loop_30/"+str(options.label)+"/"
...
for iLoop in range(options.RestartFromLoop,options.Nloop):
    ...
    for task in tasklist:
        ...
        for iFile in range(0,len(selected_filelist)):
           ...
           # print(f"ExtraCalibTree input file: {extracalibtree_filename}")
            ...
            for split in splitstat:
                ...
                outScript.write("cd /afs/cern.ch/user/p/pravesh/private/EoP/CMSSW_14_0_13_patch2/\n")
        ...
        if "BuildEopEta" in task:
            ...
            mergescript.write("cd /afs/cern.ch/user/p/pravesh/private/EoP/CMSSW_14_0_13_patch2/\n")
